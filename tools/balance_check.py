...
Это не замена полному прогону дуэлей в редакторе (Samsar → 4 «Отчёт по балансу»), а быстрая проверка:
...
def main():
    ...
    print("   (полноценный прогон боёв: в Unity — меню Samsar → 4 «Отчёт по балансу»)")
